...
<form action="{{url('/oderconfirm')}}" method="post">
    @csrf
              @foreach($data as $data)
               ...
               <tr style="position: relative; top:-40px; right:-360px;">
                   <td><a href="{{url('/remove',$data2->id)}}" class="btn btn-outline-warning">Remove</a></td>
               </tr>
               @endforeach
    ...
    <div id="appear" align="center" style="padding:10px; display:none;">
        ...
        <div style="padding:10px;">
            ...
            <input type="number" name="phone" palceholder="Enter Phone Number">
        </div>

        <div style="padding:10px;">
            <label>Address</label>
            <input type="text" name="address" palceholder="Address">
        </div>
